...
// export default class ByProduct extends React.Component{
//     render(){
...
class ByProduct extends React.Component {
  ...
  async getKeyValueData () {
    ...
    const data = await axios.get(
			`http://rmp-product-lb-756577841.us-east-1.elb.amazonaws.com/byproduct/allproduct`
    ).then(res  =>{
...
export default connect(mapStateToProps)(ByProduct)
