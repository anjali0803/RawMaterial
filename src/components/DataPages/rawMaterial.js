...
//  import { Container, Row, Col, Card, CardTitle, CardText, CardBody, CardFooter, Progress, Table, Button, UncontrolledButtonDropdown, DropdownMenu, DropdownItem, DropdownToggle } from 'reactstrap'
...
import Products from './rawMaterialForm'
...
class RawMaterial extends React.Component {
  ...
  async getKeyValueData () {
    ...
    const data = await axios.get(
			`http://rmp-product-lb-756577841.us-east-1.elb.amazonaws.com/rawmaterial/allmaterial`
    ).then(res  =>{
